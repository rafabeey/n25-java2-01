package br.com.senaisp.bauru.rafaelbey.test;
...
import br.com.senaisp.bauru.rafaelbey.classes.Produto;
...
public class CadastramentoProduto {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("3 - Constutar um produtos");
	...
	private static void cadastrarProduto(Scanner sc) {
		...
		do {
			try {
				...
				System.out.println("Confimar gravação do produto (S/N)? ");
